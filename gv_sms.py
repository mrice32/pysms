        ...
        while True:
            ...
            for time_and_message in times_and_messages:
                if time_and_message[0] < datetime.now():
                    voice.send_sms(time_and_message[2], time_and_message[1])
            ...
            for msg in extractsms(voice.sms.html):
                ...
                times_and_messages.append((new_time, '.'.join(mini_messages[1:]), sending_number))

                outgoing_message = 'Roger, roger.'

                voice.send_sms(sending_number, outgoing_message)
